...
import {View, Text, StyleSheet, ListView, TouchableOpacity, RefreshControl, ActivityIndicator} from 'react-native'
...
class RefreshListView extends PureComponent {
    ...
    shouldStartFooterRefreshing() {
        ...
        if (this.state.footerState === RefreshState.NoMoreData) {
            return false
        }
        if (this.props.dataSoure.getRowCount() === 0) {
            return false
        }
        return true
    }
